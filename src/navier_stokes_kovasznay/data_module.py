""" DataModule for Kovasznay flow (steady 2D Navier-Stokes).
"""
import os
...
class KovasznayPINNDataModule(pl.LightningDataModule):
    def __init__(
        self,
        path_to_data: str,
        args: Callable,
    ...
    def setup(self) -> None:
        ...
        self.column_names = list(["x", "y"])
        self.target_names = list(["u", "v", "p"])
        self.in_features = x_train.shape[1]
        self.out_features = y_train_BC.shape[1]  # 3: u, v, p
