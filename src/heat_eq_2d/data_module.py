""" DataModule for the 2D heat equation.
"""
import os
...
class HeatEq2DPINNDataModule(pl.LightningDataModule):
    def __init__(
        self,
        path_to_data: str,
        args: Callable,
    ...
    def setup(self) -> None:
        # Load, create dataset
        x_train, x_train_IC_BC, y_train_IC_BC, x_star = self.load_data(
            self.hparams.path_to_data
        )

        self.column_names = list(["x", "y", "t"])
